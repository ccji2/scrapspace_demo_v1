// Lens Studio Version: 4.22.0 (Internal)
// Snapchat Version: 11.81 (Internal)
...
interface ComponentNameMap {
    ...
    "Component.JointTracking3D": JointTracking3D;
    ...
    "JointTracking3D": JointTracking3D;
    "Label": Label;
...
* @unreleased
*/
declare function importModule(moduleName: (ScriptAsset|string)): Object

/**
* @unreleased
*/
declare function exportModule(obj: Object): void
...
/**
* @description The base class for data accessible through [DataComponent](https://lensstudio.snapchat.com/api/classes/DataComponent).
*/
interface AbstractData extends ScriptObject {
}

/**
* @description Interface for sending Blizzard analytics events. Accessible from [DataComponent](https://lensstudio.snapchat.com/api/classes/DataComponent).
*/
...
interface BaseMeshVisual extends Visual {
    ...
    * @description Returns the [RenderMesh](https://lensstudio.snapchat.com/api/classes/RenderMesh) for this BaseMeshVisual.
    */
    ...
    * @description Sets the [RenderMesh](https://lensstudio.snapchat.com/api/classes/RenderMesh) asset used for rendering.
    */
    ...
    * @description Returns the name of the [RenderMesh](https://lensstudio.snapchat.com/api/classes/RenderMesh) for this BaseMeshVisual.
    */
    ...
    * @description Sets the [Skin](https://lensstudio.snapchat.com/api/classes/Skin) used for rendering.
    */
...
interface BaseMultiplayerSessionOptions extends ScriptObject {
    ...
    */
    ...
    onMessageReceivedBytes: (session: MultiplayerSession, userId: string, message: number[]) => void
    ...
    */
    ...
    useRealtimeBackendDefault: boolean
...
interface BitmojiModule extends Asset {
    ...
    */
    ...
    requestBitmoji3DResourceWithParams(params: any, callback: (resource: Bitmoji3DResource) => void): void
...
interface BlendShapes extends Component {
    ...
    * @description Clears the blendshape with the matching name from the BlendShapes component.
    */
...
declare namespace BodyTrackingAsset {
    export function create(UNKNOWNNAME: BodyTrackingAssetOptions): BodyTrackingAsset
...
interface BoundedVideoTextureProvider extends TextureProvider {
    setOnPlaybackReady(onPlaybackReadyCallback: () => void): void

    setOnTextureUpdated(onTextureUpdatedCallback: () => void): void
...
* @hidden
*/
interface BufferAsset extends Asset {
}
...
* @hidden
*/
interface CameoSelfie extends ScriptObject {
    /**
    * @hidden
    ...
    * @readonly
    */
    warperEmbedderInput: Float32Array
    ...
    * @readonly
    */
    warperEmbedderInput_v2: Float32Array
    ...
    * @readonly
    */
    mainEmbedderInput: Float32Array
...
* @hidden
*/
interface CameosRecoloring extends ScriptObject {
    /**
    * @hidden
    */
    recolor(frameIndex: number, textures: Texture[]): Texture[]

    /**
    * @hidden
    */
    recolorGPU(frameIndex: number, textures: Texture[]): Texture[]
...
* @hidden
*/
interface CameosSystem extends ScriptObject {
    /**
    * @hidden
    */
    createCameoSelfie(iconImageBinAsset: BinAsset, targetSegmentationResultBinAsset: BinAsset): CameoSelfie

    /**
    * @hidden
    */
    isCameosFeatureEnabled(callback: (cameosFeatureEnabled: boolean) => void): void

    /**
    * @hidden
    */
    getDevicePerformanceMode(callback: (cameosPerformanceMode: CameosPerformanceMode) => void): void

    /**
    * @hidden
    */
    isCameoSelfieAvailable(callback: (cameoSelfieAvailable: boolean) => void): void

    /**
    * @hidden
    */
    loadCameoSelfie(onLoad: (cameoSelfie: CameoSelfie) => void, onError: (error: string) => void): void

    /**
    * @hidden
    */
    getTotalFriendCameoSelfies(callback: (totalFriendCameoSelfies: number) => void): void

    /**
    * @hidden
    */
    loadFriendCameoSelfie(friendIndex: number, onLoad: (cameoSelfie: CameoSelfie) => void, onError: (error: string) => void): void

    /**
    * @hidden
    */
    launchCameosOnboardingFlow(): void

    /**
    * @hidden
    */
    launchCameosOnboardingFlow_v2(image: Texture): void

    /**
    * @hidden
    */
    shouldShowFriendPolicyPopup(callback: (shouldShowFriendPolicyPopup: boolean) => void): void

    /**
    * @hidden
    */
    handleFriendPolicyPopupResult(isFriendPolicyAccepted: boolean): void

    /**
    * @hidden
    */
    getWarperGeneratorInput(sourceLandmarks: Float32Array): Float32Array

    /**
    * @hidden
    */
    getWarperGeneratorInput_v2(sourceLandmarks: Float32Array, targetLandmarks: Float32Array): Float32Array

    /**
    * @hidden
    */
    getMainGeneratorInput(sourceImage: Texture, sourceLandmarks: Float32Array): Float32Array

    /**
    * @hidden
    */
    getLandmarksImage_v3(sourceLandmarks: Float32Array): Float32Array

    /**
    * @hidden
    */
    getLandmarksImage_v3_1(sourceLandmarks: Float32Array): Float32Array

    /**
    * @hidden
    */
    createCameosRecoloring(configJson: string, selfies: CameoSelfie[]): CameosRecoloring

    /**
    * @hidden
    */
    sendSegmentationPatch(segmentationMask: Texture, blendMask: Texture): void

}

interface CameoTextureProvider extends TextureProvider {
    startGeneration(): void

    setCameoSelfies(cameoSelfies: CameoSelfie[]): void
...
interface Camera extends Component {
    ...
    * @description Returns a number of hardware supported render targets. The max number is 4. If the device doesnt support Multiple Render Targets this property equals 1.
    */
...
interface CloudStore extends ScriptObject {
    ...
    */
    ...
    setPersistedAsset(key: string, asset: CloudStorageWriteOptions, writeOptions: Asset, onSaved: () => void, onError: (code: string, description: string) => void): void
...
interface ColliderComponent extends Component {
    ...
    * @description Expects a LevelsetColliderAsset. Contains distance field data which describes a collider's shape. A selection of default Levelset assets can be found in Resource->Add->Hairstyle Colliders
    */
...
interface DataComponent extends Component {
    ...
    * Input | Return Type
    * --- | ---
    * "UserData"     | [`GeneralDataStore`](https://lensstudio.snapchat.com/api/classes/GeneralDataStore)
    * "Location" | [`Location`](https://lensstudio.snapchat.com/api/classes/Location)
    * "Bitmoji3D" | [`Bitmoji3D`](https://lensstudio.snapchat.com/api/classes/Bitmoji3D)
    * "SceneRecognition" | [`SceneRecognition`](https://lensstudio.snapchat.com/api/classes/SceneRecognition)
    * "Segmentation" | [`SegmentationSystem`](https://lensstudio.snapchat.com/api/classes/SegmentationSystem)
    * "DeviceMotion" | [`DeviceMotion`](https://lensstudio.snapchat.com/api/classes/DeviceMotion)
    */
...
interface DeviceInfoSystem extends ScriptObject {
    ...
    * @description Returns the PerformanceIndexes object, which provides performance information about the device.
    */
...
* @description This class has been **Deprecated**. Please instead use the [DeviceTracking](https://lensstudio.snapchat.com/api/classes/DeviceTracking) component with Tracking Mode set to Rotation.
* See the [Tracking Modes](https://lensstudio.snapchat.com/guides/general/tracking/tracking-modes) guide for more information.
...
interface HairVisual extends BaseMeshVisual {
    ...
    * @deprecated
    */
    setStrandsSceneObject(): SceneObject
...
declare namespace HandTracking3DAsset {
    export function create(UNKNOWNNAME: HandTracking3DAssetOptions): HandTracking3DAsset
...
interface InputBuilder extends ScriptObject {
    ...
    * @unreleased
    */
    setAllowCpuImageData(value: boolean): InputBuilder
...
interface JointTracking3D extends Component {
    setJoint(jointName: string, sceneObject: SceneObject): void

    getJoint(jointName: string): SceneObject

    getTrackingSupportState(): JointTracking3D.TrackingSupportState

    setInitialRotation(jointName: string, rotation: quat): void

    isTracking(jointName: string): boolean

    transformType: JointTracking3D.TransformType
    ...
    * @readonly
    */
    supportedJointNames: string[]

}

declare namespace JointTracking3D {
    enum TrackingSupportState {
        NotInitialized,
        Initializing,
        Unsupported,
        Supported
...
* This is now deprecated in favor of [Text](https://lensstudio.snapchat.com/api/classes/Text).
...
* @unreleased
*/
interface MRCSAsset extends Asset {
    /**
    * @unreleased
    */
    play(): void
...
* @unreleased
*/
interface MRCSRenderObjectProvider extends RenderObjectProvider {
}

/**
* @unreleased
*/
interface MRCSTextureProvider extends TextureProvider {
}
...
interface MultiplayerSession extends ScriptObject {
    ...
    * @description Get a value stored within the specified scope.
    */
    ...
    * @description List all values stored within the specified scope.
    */
    ...
    * @description Saves the value to the specified scope.
    */
    ...
    * @description Deletes the value from the specified scope.
    */
    ...
    */
    ...
    getLastUpdatedServerTimestamp(UNKNOWNNAME: GeneralDataStore): number
...
interface OutputBuilder extends ScriptObject {
    ...
    * @description Sets the shape of the OutputPlaceholder to be built.
    */
...
* @description Provides information about the device running the Lens. Accessible through `global.deviceInfoSystem.performanceIndexes`.
*/
...
interface RemoteMediaModule extends Asset {
    ...
    /**
    * @description Downloads a remote 3D GLTF file given a `DynamicResource`.
...
interface RemoteServiceModule extends Asset {
    performHttpRequest(requestOptions: RemoteServiceHttpRequest, onHttpRespoonse: (response: RemoteServiceHttpResponse) => void): void

    performApiRequest(request: RemoteApiRequest, onApiRespoonse: (response: RemoteApiResponse) => void): void

    getOAuth2Status(onOAuth2StatusResponse: (status: RemoteServiceModule.OAuth2Status, errorMessage: any) => void): void

    startOAuth2Flow(onOAuth2StatusResponse: (status: RemoteServiceModule.OAuth2Status, errorMessage: any) => void): void
...
interface RenderMeshVisual extends MaterialMeshVisual {
    ...
    * @description The [BlendShapes](https://lensstudio.snapchat.com/api/classes/BlendShapes) component used for rendering this mesh.
    */
    blendShape: BlendShapes
...
interface ScriptScene extends ScriptObject {
    ...
    */
    ...
    startRecordingTrackingCameraStream(filename: string): void

    stopRecordingTrackingCameraStream(): void
...
interface SegmentationTextureProvider extends TextureProvider {
    ...
    * @description Get the percentage of screen covered by the current segmentation mask, from 0 to 1.
    */
    getMaskPercentage(): number
...
* @description This class has been **deprecated** and replaced with the [Image](https://lensstudio.snapchat.com/api/classes/Image) component.
...
declare namespace TextToSpeech {
    ...
    */
    interface Options extends ScriptObject {
        ...
        * @description The language and region expressed as a BCP-47 language tag. Currently only `en_US` is supported.
        */
        languageCode: string
        ...
        * @description The name of the voice. If not set, the service will choose the default voice based on the chosen language.  Supported voice names: `Sasha`
        */
        voiceName: string
        ...
        * @description The speed which the text to speech engine will generate the text, the default is one hundred (100) which is Normal
        */
        voicePace: number
...
declare namespace TextToSpeech {
    ...
    * @description The voice style on which the TextToSpeech will be synthesized, Varying from neutral style, to a more elaborated styles depending on the voice.
...
* @description This event has been **deprecated**, please use the [OnStartEvent](https://lensstudio.snapchat.com/api/classes/OnStartEvent) instead.
...
interface VFXComponent extends BaseMeshVisual {
    ...
    * @hidden
    */
    setRefObject(systemId: string, refObject: SceneObject, type: VFXRefObjectType): void
...
interface VoiceMLModule extends Asset {
    ...
    * @hidden
    */
    useInLensControlsForListeningSessionStart(): void
...
declare namespace _palette {
    ...
    * @hidden
    */
    let CameosRecoloring: CameosRecoloring
    ...
    */
    ...
    let CameoTextureProvider: CameoTextureProvider
    ...
    */
    ...
    let JointTracking3D: JointTracking3D

    let JointTracking3D_TrackingSupportState: JointTracking3D.TrackingSupportState

    let JointTracking3D_TransformType: JointTracking3D.TransformType
    ...
    * @unreleased
    */
    let MRCSAsset: MRCSAsset

    /**
    * @unreleased
    */
    let MRCSRenderObjectProvider: MRCSRenderObjectProvider

    /**
    * @unreleased
    */
    let MRCSTextureProvider: MRCSTextureProvider
    ...
    * @hidden
    */
    let VFXRefObjectType: VFXRefObjectType
